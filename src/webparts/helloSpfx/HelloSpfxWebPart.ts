...
import styles from './HelloSpfxWebPart.module.scss';
...
export default class HelloSpfxWebPart extends BaseClientSideWebPart<IHelloSpfxWebPartProps> {
  ...
  public render(): void {
    ...
    <section class="${styles.helloSpfx} ${!!this.context.sdks.microsoftTeams ? styles.teams : ''}">
      ...
      <div>
        <h1>Hello RNT, welcome to SPFX</h1>
